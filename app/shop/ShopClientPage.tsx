...
import { Filter, X, ShoppingBag, Heart } from "lucide-react"
...
export default function ShopClientPage() {
  ...
  }, [priceRange, selectedCategories, selectedCollections])
    ...
    <main className="pt-24 pb-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-amber-900 mb-6">Shop</h1>
          <p className="text-lg text-amber-800">Browse our divine collections of luxury fashion and beauty products.</p>
        </div>
